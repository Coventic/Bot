...
export default class Resume implements IInteractionCommand {
	constructor() {}

	public config: IInteractionConfig = {
		name: 'resume',
		description: 'Resume a música tocando no momento.',
		permissions: [],
		maintenance: false,
		disabled: false,
		options: [],
	...
	public async invoke({
		...
		try {
			await manager.resume({ options, client })
			...
			const playing = new MessageEmbed()
				...
				.setDescription('Resumido com sucesso.')
